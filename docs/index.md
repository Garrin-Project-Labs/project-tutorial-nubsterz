...
<body>
  <main class="shell">
    <section class="hero">
      ...
      <p id="tagline">Welcome, Nubsterz Black Star Cat. Your meteor-dodging adventure starts here.</p>
    </section>
    ...
    <section class="game-card" aria-label="Unfinished Dodge the Meteors starter game">
      ...
      <p class="hint">Move the black star cat with arrow keys or WASD. Dodge the meteors as long as you can!</p>
    </section>
    ...
    <section class="quests">
      ...
      <ol>
        ...
        <li><strong>Pick the vibe:</strong> first vibe upgrade: the rocket is now a black star cat.</li>
